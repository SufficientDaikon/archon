...
> Comprehensive [domain] skill bundle for Archon.
...
### Step 7: Register Bundle in archon.yaml
```yaml
bundles:
  - name: <bundle-name>-kit
...
### Step 8: Update Root archon.yaml Skills List
...
# - Bundle is registered in archon.yaml
...
✅ Registered bundle in archon.yaml
...
|----------|------|-------------|
| `../../archon.yaml` | reference | See existing bundle structures |
