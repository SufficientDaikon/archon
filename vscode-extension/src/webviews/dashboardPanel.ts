...
export class DashboardPanel {
  ...
  private static readonly viewType = "omniskill.dashboard";
      ...
      (msg) => {
        switch (msg.command) {
          case "openArtifact":
            ...
            break;
          case "refresh":
            vscode.commands.executeCommand("omniskill.refreshDashboard");
            break;
        }
      },
      null,
...
<head>
    ...
    <title>OMNISKILL Pipeline Dashboard</title>
    <style>
        :root {
            --bg-primary: #1a1a2e;
            --bg-secondary: #16213e;
