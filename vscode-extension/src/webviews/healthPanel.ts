...
export class HealthPanel {
  ...
  private static readonly viewType = "archon.health";
...
<body>
    <div class="error">
        ...
        <p style="color:#a0a0b0;font-size:13px;margin-top:16px;">
            Ensure the Archon CLI is installed and accessible.
        </p>
    </div>
</body>
</html>`;
...
<head>
    ...
    <title>Archon Health Report</title>
    <style>
        body {
            font-family: var(--vscode-font-family, 'Segoe UI', sans-serif);
            background: var(--vscode-editor-background, #1a1a2e);
