...
export class SkillDetailPanel {
  private static readonly viewType = "omniskill.skillDetail";
  ...
  public static async show(skill: Skill): Promise<void> {
    ...
    try {
      ...
      documentation = `*Could not load documentation for ${skill.name}. The OMNISKILL CLI may not be available.*`;
    }
