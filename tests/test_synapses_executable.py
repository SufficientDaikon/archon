...
from archon.synapses import anti_rationalization, metacognition, security_awareness
...
def test_anti_rat_blocks():
    ...
    print("PASS: anti_rationalization blocks")
