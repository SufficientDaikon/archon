...
Core operational scripts for managing the OMNISKILL framework.

## Overview

This directory contains Python scripts that provide the operational backbone for OMNISKILL:
...
**Purpose:** Migrates skills from various formats to OMNISKILL format.
...
- Creates proper OMNISKILL structure (SKILL.md + manifest.yaml)
...
- [OMNISKILL README](../README.md) - Framework overview
