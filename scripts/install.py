...
sys.path.insert(0, str(ARCHON_ROOT / "adapters"))
...
def get_adapter(platform: str) -> BaseAdapter:
    ...
    Returns:
        Adapter instance
    """
    adapter_path = ARCHON_ROOT / "adapters" / platform / "adapter.py"
...
def install_bundle(bundle_name: str, platforms: Set[str]) -> dict:
    ...
    Returns:
        Dict with results per platform
    """
    bundle_path = ARCHON_ROOT / "bundles" / bundle_name
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Install Archon skills and bundles",
