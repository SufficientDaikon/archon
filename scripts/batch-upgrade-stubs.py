#!/usr/bin/env python3
"""
Batch upgrade all stub skills to 9-section Archon format.
...
SKILL_DEFS = {
    "ui-ux-designer": {
        ...
        "traits": [
            (
                "user-centered",
                "every design decision traces back to user research, personas, and validated pain points",
            ),
            (
                "systematic",
                "you follow a phased approach: research > IA > wireframe > UX > UI > test; never skip phases",
            ),
            (
                "accessible-first",
                "WCAG 2.1 AA compliance is a baseline, not an afterthought; contrast, keyboard nav, and screen readers are checked at every phase",
            ),
        ],
        "when_to_use": [
        ...
        "steps": [
            (
                "Research & Discovery",
                [
                    "Gather user research, personas, and pain points",
            ...
            (
                ...
                [
                    "Define site structure and navigation hierarchy",
                    "Create content taxonomy and user flows",
                    "Map primary and secondary navigation paths",
                    "Validate with card sorting or tree testing",
                ],
            ),
            (
                "Wireframing",
                [
                    "Create low-fidelity layouts for mobile, tablet, and desktop",
                    "Define content blocks, component placement, and responsive behavior",
                    "Map user flows through wireframe sequences",
            ...
            (
                "Visual Design",
                [
                    "Apply design tokens: colors, typography, spacing scale",
                    "Create high-fidelity mockups from wireframes",
                    "Design component states: default, hover, active, disabled, error",
            ...
            (
                ...
                [
                    ...
                    "Specify form behavior, validation, and error states",
            ...
            (
                "Handoff & Validation",
                [
                    "Prepare developer handoff with measurements and assets",
    ...
    "ui-visual-design": {
        ...
        "traits": [
            (
                "hierarchy-driven",
                "every layout has 3+ distinct visual levels using size, color, and spacing to guide the eye",
            ),
            (
                "token-disciplined",
                "all colors, fonts, and spacing come from a defined token system; no hardcoded values",
            ),
            (
                "trend-aware",
                "you apply modern design patterns (glassmorphism, neumorphism, gradients) when appropriate, never as decoration",
            ),
        ],
        "when_to_use": [
        ...
        "steps": [
            (
                ...
                [
                    "Define color palette: primary, secondary, neutral, semantic (error, success, warning)",
                    "Set typography scale: 6-8 sizes with consistent ratio (1.25 or 1.333)",
                    "Define spacing scale: 4px or 8px base unit",
                    "Create shadow, border-radius, and transition tokens",
                ],
            ),
            (
                "Build Visual Hierarchy",
                [
                    "Establish 3+ distinct heading levels with clear size/weight progression",
                    "Use color weight to emphasize primary actions and de-emphasize secondary",
                    "Apply whitespace to create visual grouping (proximity principle)",
                    "Design focus areas that draw the eye in the correct reading order",
                ],
            ),
            (
                "Design Components",
                [
                    "Create button hierarchy: primary, secondary, ghost, destructive",
                    "Design form elements: input, select, checkbox, radio with all states",
                    "Build card patterns with consistent padding, shadows, and borders",
                    "Design navigation: header, sidebar, breadcrumbs, tabs",
                ],
            ),
            (
                "Compose Layouts",
                [
                    "Design hero sections: headline, subtext, CTA, supporting visual",
                    "Build content sections: features grid, testimonials, pricing tables",
                    "Create responsive behavior: mobile stack, tablet adapt, desktop expand",
                    "Apply golden ratio or rule of thirds for visual balance",
                ],
            ),
            (
                "Polish and Refine",
                [
                    "Add micro-interactions: hover states, focus rings, transitions",
                    "Verify color contrast meets WCAG 2.1 AA (4.5:1 normal, 3:1 large)",
                    "Check visual consistency across all components and pages",
    ...
    "ux-interaction-design": {
        ...
        "traits": [
            (
                "state-aware",
                "every interactive element has a defined state machine: idle, hover, active, loading, success, error, disabled",
            ),
            (
                "feedback-obsessed",
                "every user action gets immediate, proportional feedback; silence is a bug",
            ),
            (
                "motion-principled",
                "animations follow Material/Apple motion principles: purposeful, quick (200-300ms), physics-based easing",
            ),
        ],
        "when_to_use": [
        ...
        "steps": [
            (
                ...
                [
                    ...
                    "Define state machine for each: idle > hover > active > loading > success/error",
                    "Document transition triggers between states",
                    "Specify disabled and empty states",
                ],
            ),
            (
                "Design Feedback Patterns",
                [
                    "Loading: skeleton screens for content, spinners for actions, progress bars for uploads",
                    "Success: checkmark animation, toast notification, state change",
                    "Error: inline validation, field highlighting, recovery guidance",
                    "Empty: illustration + CTA for empty states",
                ],
            ),
            (
                "Specify Form UX",
            ...
            (
                "Define Transitions",
                [
                    "View transitions: slide, fade, or cross-fade based on navigation direction",
                    "Duration: 200ms for micro-interactions, 300ms for view transitions",
                    "Easing: ease-out for entrances, ease-in for exits, ease-in-out for state changes",
                    "Stagger: 50ms delay between sequential element animations",
                ],
            ),
            (
                "Document Specifications",
                [
                    "Create interaction specification document with state diagrams",
                    "Include timing, easing, and trigger details for each animation",
                    "Provide fallback behavior for reduced-motion preference",
                    "Reference component library patterns where applicable",
                ],
            ),
        ],
        "dos": [
    ...
    "ux-research": {
        ...
        "traits": [
            (
                "evidence-driven",
                "every insight is backed by data: interview quotes, survey results, or analytics; no assumptions presented as findings",
            ),
            (
                "synthesis-focused",
                "raw data becomes actionable insights through affinity mapping, thematic analysis, and prioritized recommendations",
            ),
            (
                "method-matched",
                "research method matches the question: interviews for 'why', surveys for 'how many', analytics for 'what'",
            ),
        ],
        "when_to_use": [
        ...
        "steps": [
            (
                ...
                [
                    ...
                    "Select methods: interviews (why), surveys (how many), analytics (what)",
                    "Recruit participants matching target user profiles",
                    "Prepare interview guides or survey instruments",
                ],
            ),
            (
                "Conduct Research",
                [
                    "Run user interviews with open-ended questions",
                    "Distribute surveys with mix of quant and qual questions",
                    "Analyze existing analytics data for behavioral patterns",
                    "Observe users in their natural context if possible",
                ],
            ),
            (
                "Create Personas",
                [
                    "Synthesize interview data into 3-5 primary personas",
                    "Include: demographics, goals, frustrations, behaviors, quotes",
                    "Rank personas by business impact and frequency",
            ...
            (
                "Map User Journeys",
                [
                    "Map current-state journey for each primary persona",
                    "Identify pain points, emotions, and touchpoints at each stage",
                    "Mark opportunities for improvement",
                    "Create future-state journey showing proposed improvements",
                ],
            ),
            (
                "Analyze Competition",
                [
                    "Identify 5+ direct and indirect competitors",
                    "Create feature comparison matrix",
                    "Analyze UX strengths and weaknesses",
                    "Extract best practices and innovation opportunities",
                ],
            ),
            (
                "Synthesize and Report",
                [
                    "Run affinity mapping on all findings",
                    "Identify themes and prioritize by impact/effort",
                    "Write research brief with executive summary",
                    "Present actionable recommendations ranked by priority",
                ],
            ),
        ],
        "dos": [
    ...
    "ux-test-suite": {
        ...
        "traits": [
            (
                "task-focused",
                "every test measures task completion: can users accomplish their goal, how long does it take, where do they get stuck",
            ),
            (
                "metric-driven",
                "usability is scored with SUS, task completion rate, time-on-task, and error rate; no subjective assessments",
            ),
            (
                "recovery-testing",
                "error states are tested as thoroughly as happy paths; the measure of good UX is how gracefully it fails",
            ),
        ],
        "when_to_use": [
        ...
        "steps": [
            (
                "Define Test Plan",
                [
                    "Identify 5-8 key tasks to test (login, search, checkout, etc.)",
                    "Define success criteria per task (completion, time, errors)",
                    "Select testing method: moderated, unmoderated, remote, in-person",
            ...
            (
                ...
                [
                    "Write task scenarios in user language (not technical)",
                    "Define expected paths and acceptable alternatives",
                    "Include error recovery scenarios (what if they make a mistake?)",
            ...
            (
                "Run Usability Tests",
                [
                    "Observe users attempting each task without assistance",
                    "Record: completion (yes/no), time, errors, path taken",
                    "Note verbal feedback, confusion points, and workarounds",
            ...
            (
                "Analyze Results",
                [
                    "Calculate task completion rate per task",
                    "Calculate average time-on-task vs benchmark",
                    "Count and categorize errors (slips vs mistakes)",
                    "Compute SUS score (>68 = above average, >80 = excellent)",
                ],
            ),
            (
                "Identify Usability Issues",
                [
                    "Map issues to specific screens/components",
                    "Classify severity: critical (blocks task), major (causes confusion), minor (suboptimal)",
            ...
            (
                ...
                [
                    "Write UX test report with quantitative results",
                    "Include per-task analysis with completion rates and times",
                    "List findings ranked by severity with fix recommendations",
                    "Provide pass/fail verdict against success criteria",
                ],
            ),
        ],
        "dos": [
    ...
    "wireframing": {
        ...
        "traits": [
            (
                "layout-first",
                "structure before style; every wireframe defines content hierarchy, grid alignment, and responsive behavior before any visual treatment",
            ),
            (
                "responsive-native",
                "mobile wireframes are designed first, then adapted up to tablet and desktop; not the reverse",
            ),
            (
                "pattern-based",
                "common patterns (hero, features grid, pricing table, dashboard) are reused from a library, not reinvented per page",
            ),
        ],
        "when_to_use": [
        ...
        "steps": [
            (
                "Define Grid System",
                [
                    "Choose grid: 12-column for web, 4-column for mobile",
                    "Set gutter width: 16px mobile, 24px desktop",
                    "Define max content width: 1200px or 1440px",
                    "Establish margin behavior at each breakpoint",
                ],
            ),
            (
                "Map Content Blocks",
                [
                    "List all content types for the page (hero, features, CTA, footer)",
                    "Prioritize by importance (what should users see first?)",
                    "Assign approximate heights and widths per block",
                    "Define stacking order for mobile (most important first)",
                ],
            ),
            (
                "Create Mobile Wireframe",
                [
                    "Lay out content blocks in single-column stack",
                    "Define touch target sizes (min 44x44px)",
                    "Plan bottom navigation or hamburger menu",
                    "Test readability at 320px minimum width",
                ],
            ),
            (
                "Adapt to Desktop",
                [
                    "Expand to multi-column layout using grid system",
                    "Place navigation in header/sidebar",
                    "Add whitespace for visual breathing room",
                    "Ensure content doesn't stretch beyond readable line lengths (~65 chars)",
                ],
            ),
            (
                "Wireframe User Flows",
                [
                    "Create wireframe sequences for key user paths",
                    "Show page-to-page transitions with arrows",
                    "Include error states and empty states",
                    "Mark decision points and alternative paths",
                ],
            ),
        ],
        "dos": [
    ...
    "info-architecture": {
        ...
        "traits": [
            (
                "findability-obsessed",
                "every piece of content must be reachable within 3 clicks; if users can't find it, it doesn't exist",
            ),
            (
                "taxonomy-disciplined",
                "content is organized by user mental models, not internal org structure; validated through card sorting",
            ),
            (
                "flow-optimized",
                "user flows minimize steps, eliminate dead ends, and always provide clear next actions",
            ),
        ],
        "when_to_use": [
        ...
        "steps": [
            (
                ...
                [
                    "Inventory all content types and pages",
                    "Categorize by topic, audience, and frequency of use",
                    "Identify gaps and redundancies",
                    "Map current navigation paths and pain points",
                ],
            ),
            (
                "Define Navigation Structure",
                [
                    "Primary navigation: max 7 top-level items",
                    "Secondary navigation for sub-categories",
                    "Utility navigation: search, account, settings",
                    "Breadcrumb paths for deep content",
                ],
            ),
            (
                "Create Sitemap",
                [
                    ...
                    "Indicate content relationships and cross-links",
                    "Mark dynamic vs static content",
            ...
            (
                "Design User Flows",
                [
                    "Map primary user tasks: find product, complete purchase, get support",
                    "Define entry points, decision points, and exit points",
                    "Include success paths and error recovery paths",
            ...
            (
                "Validate Structure",
                [
                    "Run card sorting with representative users",
                    "Conduct tree testing on proposed hierarchy",
                    "Verify 3-click rule for critical content",
                    "Test search and filtering discoverability",
                ],
            ),
        ],
        "dos": [
...
SIMPLE_SKILLS = {
    "frontend-design": (
        "Frontend Designer",
        "Create production-grade frontend interfaces with modern frameworks, responsive layouts, and polished UI.",
        "Frontend Implementation Expert",
        ["framework-fluent", "responsive-native", "performance-conscious"],
        [
            "Building web pages, components, or applications",
            "Implementing designs from mockups or wireframes",
            "Creating responsive layouts with CSS Grid/Flexbox",
            "Optimizing frontend performance",
        ],
        "frontend, web development, React, CSS, responsive, components",
        [
            "Implementing visual designs without specs (use ui-visual-design first)",
            "Backend API work (use backend-development)",
        ],
        ["frontend", "web", "react", "css", "responsive"],
        ["frontend", "web components", "responsive design", "CSS", "React", "landing page"],
    ),
    "mobile-design": (
        "Mobile Design",
        "Design mobile-first interfaces following iOS and Android platform conventions with touch-optimized interactions.",
        "Mobile Design Specialist",
        ["platform-native", "touch-optimized", "performance-budgeted"],
        [
            "Designing mobile app interfaces",
            "Creating touch-friendly interactions",
            "Following iOS HIG or Material Design guidelines",
            "Optimizing for mobile performance constraints",
        ],
        "mobile design, iOS, Android, touch UI, mobile UX, responsive mobile",
        [
            "Building web-only responsive layouts (use wireframing)",
            "Implementing mobile code (use frontend-design or capacitor-best-practices)",
        ],
        ["mobile", "ios", "android", "touch", "responsive"],
        ["mobile design", "iOS design", "Android design", "touch interface", "mobile UX"],
    ),
    "systematic-debugging": (
        "Systematic Debugging",
        "Four-phase debugging framework: reproduce, isolate, identify root cause, then fix. Never jump to solutions.",
        "Debug Methodologist",
        ["reproduce-first", "hypothesis-driven", "root-cause-focused"],
        [
            "Investigating any bug or unexpected behavior",
            "Debugging test failures",
            "Troubleshooting production issues",
            "Understanding error messages before fixing",
        ],
        "debugging, bug fix, error investigation, root cause analysis, troubleshooting",
        ["Writing new features (use implementer)", "Reviewing code quality (use reviewer)"],
        ["debugging", "troubleshooting", "root-cause"],
        ["debugging", "bug fix", "error investigation", "troubleshooting", "root cause"],
    ),
    "writing-skills": (
        "Writing Skills",
        "Create, edit, and validate Archon skill definitions following the 9-section template format.",
        "Skill Author",
        ["template-compliant", "manifest-complete", "resource-linked"],
        [
            "Creating new Archon skills",
            "Editing or upgrading existing skills",
            "Verifying skills against the 9-section template",
            "Writing manifest.yaml with proper triggers and tags",
        ],
        "write skill, create skill, skill template, Archon format, skill authoring",
        ["Using skills (use the specific skill)", "Finding skills (use find-skills)"],
        ["meta", "skill-authoring", "archon"],
        ["write skill", "create skill", "skill template", "edit skill", "skill format"],
    ),
    "find-skills": (
        "Find Skills",
        "Discover and recommend installed Archon skills based on user intent, keywords, and task context.",
        "Skill Discovery Agent",
        ["intent-matching", "keyword-aware", "context-sensitive"],
        [
            "Finding which skill to use for a task",
            "Browsing available skills by category",
            "Recommending skills based on user description",
            "Checking if a skill exists for a domain",
        ],
        "find skill, which skill, available skills, skill for, discover skill",
        [
            "Creating new skills (use writing-skills or add-skill)",
            "Implementing features (use the recommended skill directly)",
        ],
        ["meta", "discovery", "routing"],
        ["find skill", "which skill", "discover skill", "available skills", "skill for"],
    ),
    "packager": (
        "Packager",
        "Package Archon agents, skills, and templates as shareable git repos with proper structure.",
        "Package Engineer",
        ["structure-compliant", "dependency-aware", "distribution-ready"],
        [
            "Packaging skills or agents for sharing",
            "Creating shareable git repos from Archon artifacts",
            "Publishing skills to a registry or marketplace",
            "Exporting SDD artifacts for other teams",
        ],
        "package, share, publish, export, distribute, git repo",
        ["Creating skills (use add-skill)", "Installing skills (use find-skills)"],
        ["meta", "packaging", "distribution"],
        ["package", "share", "publish", "export", "distribute"],
    ),
    "prompt-architect": (
        "Prompt Architect",
        "Analyze and transform prompts using research-backed frameworks (CO-STAR, RISEN, Chain of Thought) for maximum effectiveness.",
        "Prompt Engineering Expert",
        ["framework-driven", "iterative-refinement", "context-optimized"],
        [
            "Improving prompt effectiveness",
            "Selecting the right prompting framework",
            "Restructuring prompts for better AI outputs",
            "Teaching prompt engineering techniques",
        ],
        "prompt engineering, CO-STAR, RISEN, chain of thought, prompt optimization",
        ["Implementing code (use implementer)", "Writing specifications (use spec-writer)"],
        ["prompt-engineering", "ai", "frameworks"],
        ["prompt engineering", "improve prompt", "CO-STAR", "RISEN", "chain of thought"],
    ),
    "qa-test-planner": (
        "QA Test Planner",
        "Generate comprehensive test plans, manual test cases, regression suites, and bug reports for QA teams.",
        "QA Planning Specialist",
        ["coverage-driven", "risk-based", "regression-aware"],
        [
            "Creating test plans for new features",
            "Designing manual test cases from requirements",
            "Building regression test suites",
            "Writing detailed bug reports",
        ],
        "test plan, test cases, regression testing, QA, bug report, test strategy",
        [
            "Running automated E2E tests (use e2e-testing-patterns)",
            "Testing usability (use ux-test-suite)",
        ],
        ["testing", "qa", "test-planning"],
        ["test plan", "test cases", "QA", "regression testing", "bug report"],
    ),
    "skills-index": (
        "Skills Index",
        "Master index of all installed Archon skills with categories, descriptions, and usage guidance.",
        "Skills Catalog Manager",
        ["comprehensive", "categorized", "up-to-date"],
        [
            "Browsing all available skills",
            "Understanding skill categories and bundles",
            "Finding the right skill for a domain",
            "Getting an overview of framework capabilities",
        ],
        "skills index, skill catalog, all skills, skill list, capabilities",
        ["Using a specific skill (invoke it directly)", "Creating new skills (use add-skill)"],
        ["meta", "index", "catalog"],
        ["skills index", "all skills", "skill catalog", "capabilities"],
    ),
    "capacitor-best-practices": (
        "Capacitor Best Practices",
        "Build cross-platform mobile apps with Capacitor following best practices for plugins, performance, and deployment.",
        "Capacitor Expert",
        ["cross-platform", "plugin-savvy", "native-bridged"],
        [
            "Setting up Capacitor projects",
            "Using Capacitor plugins correctly",
            "Optimizing mobile performance",
            "Deploying to iOS and Android",
        ],
        "Capacitor, mobile app, cross-platform, native bridge, plugins",
        ["Pure web design (use frontend-design)", "Native-only development (use mobile-design)"],
        ["mobile", "capacitor", "cross-platform"],
        ["Capacitor", "mobile app", "cross-platform", "native bridge"],
    ),
    "fastmcp": (
        "FastMCP",
        "Build MCP servers in Python with FastMCP framework for tools, resources, and prompts exposed to LLMs.",
        "MCP Server Developer",
        ["tool-oriented", "schema-strict", "deployment-ready"],
        [
            "Creating MCP servers with Python/FastMCP",
            "Defining tools, resources, and prompts",
            "Implementing OAuth and storage backends",
            "Deploying to FastMCP Cloud",
        ],
        "FastMCP, MCP server, Model Context Protocol, tools, resources, prompts",
        [
            "Building Node/TypeScript MCP servers (use mcp-builder)",
            "General backend APIs (use backend-development)",
        ],
        ["mcp", "fastmcp", "python", "ai-tools"],
        ["FastMCP", "MCP server", "Model Context Protocol", "MCP tools"],
    ),
    "mcp-builder": (
        "MCP Builder",
        "Build production-quality MCP servers that enable LLMs to interact with external services through well-designed tools.",
        "MCP Server Architect",
        ["tool-design-focused", "schema-disciplined", "error-resilient"],
        [
        ...
        "MCP server, MCP builder, Model Context Protocol, MCP tools, MCP integration",
        [
            "Python-specific MCP with FastMCP (use fastmcp)",
            "General API design (use backend-development)",
        ],
    ...
    "mcp-server-index": (
        "MCP Server Index",
        "RAG-indexed registry of configured MCP servers, available tools, and dispatch rules.",
        "MCP Registry Manager",
        ["registry-complete", "tool-cataloged", "dispatch-optimized"],
        [
            "Browsing available MCP servers and tools",
            "Finding which MCP server handles a specific capability",
            "Checking MCP server configuration",
            "Understanding MCP tool dispatch rules",
        ],
        "MCP index, MCP servers, MCP tools, MCP registry, tool catalog",
        [
            "Building new MCP servers (use mcp-builder or fastmcp)",
            "General tool discovery (use find-skills)",
        ],
        ["mcp", "registry", "index"],
        ["MCP index", "MCP servers", "MCP tools", "MCP registry"],
    ),
    "omega-gdscript-expert": (
        "Omega GDScript Expert",
        "Meta Godot/GDScript skill composing all Godot skills with MCP routing and self-evaluation for stable, high-performance code.",
        "Godot Meta-Expert",
        ["composition-aware", "quality-gated", "backward-compatible"],
        [
            "Complex Godot development requiring multiple skill areas",
            "Code review against all Godot best practices",
            "Architecture decisions for Godot projects",
            "Self-evaluating GDScript code quality",
        ],
        "Godot expert, GDScript expert, Godot architecture, Godot meta, Godot master",
        [
            "Simple GDScript patterns (use godot-gdscript-patterns)",
            "Particle effects only (use godot-particles)",
        ],
        ["godot", "gdscript", "meta", "expert"],
        ["Godot expert", "GDScript master", "Godot architecture"],
    ),
    "vercel-react-best-practices": (
        "Vercel React Best Practices",
        "Optimize React and Next.js applications following Vercel Engineering guidelines for performance.",
        "Next.js Performance Specialist",
        ["bundle-conscious", "server-first", "cache-optimized"],
        [
            "Optimizing Next.js application performance",
            "Implementing server components and streaming",
            "Reducing JavaScript bundle size",
            "Configuring ISR, SSG, and dynamic rendering",
        ],
        "Next.js, Vercel, React performance, bundle optimization, server components, ISR",
        [
            "General React patterns (use react-best-practices)",
            "Backend APIs (use backend-development)",
        ],
        ["nextjs", "vercel", "react", "performance"],
        ["Next.js", "Vercel", "React performance", "bundle optimization", "server components"],
    ),
    "web-design-guidelines": (
        "Web Design Guidelines",
        "Review UI code against Web Interface Guidelines for accessibility, usability, and design compliance.",
        "Web Standards Auditor",
        ["standards-driven", "accessibility-first", "compliance-focused"],
        [
            "Reviewing UI against web interface guidelines",
            "Auditing accessibility compliance",
            "Checking design system adherence",
            "Evaluating responsive behavior",
        ],
        "web guidelines, UI audit, accessibility check, design compliance, web standards",
        [
            "Creating new designs (use ui-visual-design)",
            "Running automated E2E tests (use e2e-testing-patterns)",
        ],
        ["web", "guidelines", "accessibility", "audit"],
        ["web guidelines", "UI audit", "accessibility", "design compliance"],
    ),
    "webapp-testing": (
        "Webapp Testing",
        "Test web applications using Playwright for frontend verification, screenshot capture, and browser log analysis.",
        "Web App Test Engineer",
        ["browser-native", "screenshot-driven", "log-aware"],
        [
            "Testing local web applications with Playwright",
            "Capturing browser screenshots for verification",
            "Viewing browser console logs",
            "Debugging frontend UI behavior",
        ],
        "webapp testing, Playwright, browser testing, screenshots, console logs",
        [
            "Full E2E test suites (use e2e-testing-patterns)",
            "Manual usability testing (use ux-test-suite)",
        ],
        ["testing", "playwright", "browser"],
        ["webapp testing", "Playwright", "browser testing", "screenshots"],
    ),
    "godot-best-practices": (
        "Godot Best Practices",
        "Guide Godot 4.x GDScript coding with scene organization, signals, resources, state machines, and performance.",
        "Godot Architecture Expert",
        ["scene-organized", "signal-driven", "performance-conscious"],
        [
            "Organizing Godot scenes and nodes",
            "Implementing signal patterns (signal up, call down)",
            "Using resources and autoloads correctly",
            "Designing state machines and object pools",
        ],
        "Godot, GDScript, game development, signals, scenes, state machine, autoload",
        [
            "Building particle effects (use godot-particles)",
            "Advanced GDScript patterns (use godot-gdscript-patterns)",
        ],
        ["godot", "gdscript", "game-development"],
        ["Godot", "GDScript", "game development", "signals", "scenes"],
    ),
    "godot-debugging": (
        "Godot Debugging",
        "Debug Godot engine errors, crashes, and unexpected behavior with systematic troubleshooting.",
        "Godot Debug Specialist",
        ["error-interpreting", "systematic", "crash-resilient"],
        [
            "Debugging Godot engine errors and crashes",
            "Interpreting GDScript error messages",
            "Fixing common Godot bugs",
            "Troubleshooting unexpected game behavior",
        ],
        "Godot debugging, GDScript errors, Godot crash, game bugs, troubleshooting",
        [
            "General debugging methodology (use systematic-debugging)",
            "Godot best practices (use godot-best-practices)",
        ],
        ["godot", "debugging", "troubleshooting"],
        ["Godot debugging", "GDScript error", "Godot crash", "game bug"],
    ),
    "godot-gdscript-mastery": (
        "Godot GDScript Mastery",
        "Expert GDScript with static typing, signal architecture, unique nodes, and performance patterns.",
        "GDScript Expert",
        ["statically-typed", "signal-architected", "performance-tuned"],
        [
            "Writing expert-level GDScript with static typing",
            "Designing signal architectures (signal up, call down)",
            "Using unique nodes and @onready patterns",
            "Optimizing GDScript performance",
        ],
        "GDScript, static typing, signals, @onready, class_name, GDScript mastery",
        ["Particle effects (use godot-particles)", "Debugging (use godot-debugging)"],
        ["godot", "gdscript", "mastery"],
        ["GDScript", "static typing", "signals", "@onready", "class_name"],
    ),
    "godot-gdscript-patterns": (
        "Godot GDScript Patterns",
        "Master Godot 4 design patterns: signals, state machines, scenes, and optimization.",
        "GDScript Pattern Specialist",
        ["pattern-fluent", "composition-native", "optimization-aware"],
        [
            "Implementing Godot design patterns",
            "Building state machines in GDScript",
            "Using composition over inheritance",
            "Optimizing game systems",
        ],
        "GDScript patterns, state machine, signals, composition, Godot patterns",
        ["Debugging issues (use godot-debugging)", "Particle effects (use godot-particles)"],
        ["godot", "gdscript", "design-patterns"],
        ["GDScript patterns", "state machine", "Godot patterns", "composition"],
    ),
    "godot-particles": (
        "Godot Particles",
        "Create GPU particle systems for explosions, magic, weather, and trails using GPUParticles2D/3D.",
        "Godot VFX Specialist",
        ["gpu-optimized", "physically-modeled", "visually-layered"],
        [
            "Creating particle effects (explosions, fire, smoke)",
            "Designing magic and weather VFX",
            "Building trail effects",
            "Optimizing particle performance",
        ],
        "particles, VFX, GPUParticles2D, explosion, fire, smoke, weather, trails",
        [
            "General Godot architecture (use godot-best-practices)",
            "GDScript coding (use godot-gdscript-patterns)",
        ],
        ["godot", "particles", "vfx"],
        ["particles", "VFX", "GPUParticles", "explosion", "fire", "smoke"],
    ),
    "django-expert": (
        "Django Expert",
        "Expert Django development for robust Python web applications with ORM, admin, and authentication.",
        "Django Expert",
        ["convention-following", "battery-using", "security-minded"],
        [
            "Building Django web applications",
            "Configuring Django admin, auth, and middleware",
            "Designing Django project structure",
            "Implementing Django views, templates, and forms",
        ],
        "Django, Python web, Django admin, Django auth, Django views, ORM",
        [
            "Django REST APIs specifically (use django-rest-framework)",
            "Django ORM patterns specifically (use django-orm-patterns)",
        ],
        ["django", "python", "web"],
        ["Django", "Python web", "Django admin", "Django auth"],
    ),
    "django-framework": (
        "Django Framework",
        "Full-featured Django framework patterns with batteries included: ORM, admin, auth, middleware.",
        "Django Framework Specialist",
        ["batteries-included", "middleware-aware", "template-proficient"],
        [
            "Setting up Django projects from scratch",
            "Configuring settings, middleware, and URL routing",
            "Using Django's built-in features effectively",
            "Implementing templates, forms, and admin",
        ],
        "Django framework, Django setup, Django middleware, Django settings, Django templates",
        [
            "REST API development (use django-rest-framework)",
            "ORM-specific patterns (use django-orm-patterns)",
        ],
        ["django", "python", "framework"],
        ["Django framework", "Django setup", "Django middleware", "Django templates"],
    ),
    "django-orm-patterns": (
        "Django ORM Patterns",
        "Django ORM patterns with models, queries, relationships, managers, and migrations.",
        "Django ORM Specialist",
        ["query-optimized", "relationship-modeled", "migration-safe"],
        [
            "Designing Django models and relationships",
            "Writing efficient ORM queries",
            "Creating custom managers and querysets",
            "Managing migrations safely",
        ],
        "Django ORM, models, queries, relationships, managers, migrations, QuerySet",
        [
            "General Django development (use django-expert)",
            "REST API serialization (use django-rest-framework)",
        ],
        ["django", "orm", "database"],
        ["Django ORM", "models", "queries", "migrations", "QuerySet"],
    ),
    "django-rest-framework": (
        "Django REST Framework",
        "Build REST APIs with Django REST Framework: serializers, viewsets, authentication, and permissions.",
        "DRF API Specialist",
        ["serializer-driven", "viewset-fluent", "permission-layered"],
        [
            "Building REST APIs with DRF",
            "Creating serializers and viewsets",
            "Implementing authentication and permissions",
            "Designing API throttling and pagination",
        ],
        "Django REST Framework, DRF, serializers, viewsets, API, authentication",
        [
            "General Django development (use django-expert)",
            "ORM patterns (use django-orm-patterns)",
        ],
        ["django", "drf", "rest-api"],
...
def generate_simple_skill_md(
    name, title, tagline, role, traits, when_to_use, keywords, anti_patterns, tags, trigger_kw
):
...
def main():
    ...
    for skill_dir in sorted(SKILLS_DIR.iterdir()):
        ...
        if name in SKILL_DEFS:
            ...
            content = generate_simple_skill_md(
                name, title, tagline, role, traits, when, kw, anti, tags, trigger_kw
            )
            manifest_content = generate_manifest(
                name,
                tagline,
