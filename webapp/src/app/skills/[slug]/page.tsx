...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    title: `${skill.name} — OMNISKILL Skill`,
      ...
      <div className="mx-auto max-w-4xl">
            ...
            {platforms.map((platform) => (
              <div key={platform.id} className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <InstallCommand
                    command={`omniskill install ${skill.slug} --platform ${platform.id}`}
                    compact
                  />
                </div>
              </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
          ...
          <div className="border border-dashed border-white/20 rounded-lg p-8 text-center">
            ...
            <a
              href={`https://github.com/SufficientDaikon/omniskill/tree/main/skills/${skill.slug}`}
              target="_blank"
