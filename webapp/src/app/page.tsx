      ...
      <section className="relative px-4 sm:px-6 lg:px-8 py-16 border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-brand-muted mb-10 max-w-lg mx-auto">
            Write skills once and deploy them anywhere. Archon adapts to your
            IDE of choice.
          </p>
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-brand-muted mb-8 max-w-lg mx-auto">
            Install Archon and start using expert AI skills in seconds. No
            config, no friction.
          </p>
          <div className="max-w-md mx-auto mb-8">
            <InstallCommand command="pip install archon" />
          </div>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/skills/"
