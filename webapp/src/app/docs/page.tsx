...
export const metadata: Metadata = {
  title: "Documentation",
  description:
    "Learn how to use OMNISKILL — getting started guides, skill creation, architecture, and more.",
  openGraph: {
    title: "Documentation — OMNISKILL",
    description: "Comprehensive documentation for the OMNISKILL framework.",
  },
};
...
const docSections = [
  {
    ...
    description:
      "Install OMNISKILL, configure your platform, and run your first skill in minutes.",
    icon: "🚀",
    href: "https://github.com/SufficientDaikon/omniskill#readme",
  },
  {
    title: "Creating Skills",
    description:
      "Learn the OMNISKILL skill format — manifest.yaml, SKILL.md, resources, examples, and tests.",
    icon: "🧩",
    href: "https://github.com/SufficientDaikon/omniskill/blob/main/docs/creating-skills.md",
  },
  {
    ...
    icon: "🤖",
    href: "https://github.com/SufficientDaikon/omniskill/blob/main/docs/building-agents.md",
  },
  {
    ...
    icon: "🔗",
    href: "https://github.com/SufficientDaikon/omniskill/blob/main/docs/pipelines.md",
  },
  {
    title: "Platform Adapters",
    description:
      "How OMNISKILL adapts skills to Claude Code, Copilot CLI, Cursor, Windsurf, and Antigravity.",
    icon: "🌐",
    href: "https://github.com/SufficientDaikon/omniskill/blob/main/docs/adapters.md",
  },
  {
    ...
    icon: "📋",
    href: "https://github.com/SufficientDaikon/omniskill/blob/main/docs/sdd.md",
  },
  {
    title: "Contributing",
    description:
      "How to contribute skills, agents, adapters, and improvements to OMNISKILL.",
    icon: "🤝",
  ...
  },
  {
    ...
    description:
      "Deep dive into OMNISKILL's internal architecture — manifests, routing, and the skill lifecycle.",
    icon: "🏗️",
    href: "https://github.com/SufficientDaikon/omniskill/blob/main/docs/architecture.md",
  },
  {
    title: "Changelog",
    description:
      "Track all changes, additions, and improvements across OMNISKILL versions.",
    icon: "📝",
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-brand-muted">
                Install OMNISKILL and get your first skill running in under 2
                minutes.
              </p>
            </div>
