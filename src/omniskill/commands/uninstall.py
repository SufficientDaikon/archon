"""``omniskill uninstall`` — remove components (US-7, FR-019 through FR-022)."""
...
from omniskill.core.installer import uninstall_skill_from_platform, resolve_target_platforms
