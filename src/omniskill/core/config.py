"""Configuration file management for OMNISKILL CLI.

Manages ``~/.omniskill/config.yaml`` — the user-level configuration file
...
from omniskill.utils.paths import get_omniskill_home, get_config_path, get_state_path
...
VALID_KEYS: dict[str, Any] = {
    ...
    "verbose": False,
    "color": True,
    "omniskill_root": None,       # override root path
...
def is_initialized() -> bool:
    """Return True if ``~/.omniskill/config.yaml`` exists."""
