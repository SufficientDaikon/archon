"""``archon list`` — list components (US-4, FR-028 through FR-030)."""
...
def _show_summary(reg: Registry) -> None:
    ...
    console.print()
    console.rule(f"[bold cyan]Archon Registry — v{reg.version}[/bold cyan]")
    console.print()
    ...
    console.print("  archon list skills      — list all skills")
    console.print("  archon list agents      — list all agents")
    console.print("  archon list bundles     — list all bundles")
    console.print("  archon list pipelines   — list all pipelines")
    console.print("  archon list synapses    — list all synapses")
    console.print()
