"""``archon update`` — check for and apply updates (US-9, FR-049 through FR-051)."""
...
def update_cmd(
    ...
    """Check for or apply Archon updates."""
    ...
    if check or True:  # For now, always check mode (actual update requires network)
        ...
        console.print()
        console.rule("[bold cyan]Archon Update Check[/bold cyan]")
        console.print()
        ...
        if not updates:
            ...
            console.print("    archon install --all --force")
